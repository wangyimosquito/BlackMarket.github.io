...
# with open("./reduced_subGraph2/node5.json",'r') as load_f:
#     load_dict = json.load(load_f)
#     # print(load_dict)

# with open("./reduced_subGraph2/link5.json",'r') as load_f:
#     load_dict_link = json.load(load_f)

with open("./task2/subGraph/node9.json",'r') as load_f:
    load_dict = json.load(load_f)
    # print(load_dict)

with open("./task2/subGraph/link9.json",'r') as load_f:
    load_dict_link = json.load(load_f)
